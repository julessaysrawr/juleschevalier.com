      ...
      <LayoutMain>
        <main>
          <div className="flex-container space-around wrap">
            <button onClick={() => this.randomHandler('create')} className="button">
              create
            </button>
            <button onClick={() => this.randomHandler('relax')} className="button">
              relax
            </button>
            <button onClick={() => this.randomHandler('strongBody')} className="button">
              strong body
            </button>
            <button onClick={() => this.randomHandler('clearMind')} className="button">
              clear mind
            </button>
          </div>
