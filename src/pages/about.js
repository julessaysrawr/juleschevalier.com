        ...
        <div className="flex-container space-below-m">
          <div className="flex-column">
            ...
            <div className="">
              ...
              <p>
                Native nomad. I currently live in Western Massachusetts with my handsome husband
                David and our kids: Mr. Gizmo, Lucius, and General Grievous.
              </p>
              <p>
                Prospector of adventure and beauty. Mindfulness. Food is medicine. Gymnastic
                strength training. On a minimalist journey.
              </p>
              <p>
                INTJ, though most would guess I'm an extrovert. Strategic and analytical, which
                leads to overthinking{' '}
                <Emoji symbol="😆" label="Face With Stuck-out Tongue And Tightly-closed Eyes" />
              </p>
              <p>
                I'm driven to improve through experiments. My super power is I'm a growth catalyst.
              </p>
